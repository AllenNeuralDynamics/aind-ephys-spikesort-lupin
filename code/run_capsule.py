...
# LOCAL
URL = "https://github.com/AllenNeuralDynamics/aind-ephys-spikesort-lupin"
VERSION = "1.0"
...
parser = argparse.ArgumentParser(description="Spike sort ecephys data with Lupin")
...
skip_motion_correction_help = "Whether to skip Lupin motion correction. Default: False"
...
if __name__ == "__main__":
    ...
    for recording_folder in preprocessed_folders:
        ...
        try:
            ...
            spikesorting_notes += f"\n- Lupin found {n_original_units} units, "
