...
This capsule is designed to spike sort ephys data using Lupin, a spike sorting algorithm developed and optimized with SpikeInterface sorting components.
